...
#BSUB -J EXP03_RiskGate_Only[1-10]
#BSUB -q hpc
#BSUB -o logs/exp03_%I.out
#BSUB -e logs/exp03_%I.err
#BSUB -n 1
#BSUB -W 01:00
#BSUB -R "rusage[mem=4GB]"


# Risk gate only, no compute switching (60s fixed) (proactive)
...
"$PYTHON_BIN" -m scripts.runner.master_runner --exp EXP03 --seed $SEED

echo "Completed EXP03 - Seed $SEED"
