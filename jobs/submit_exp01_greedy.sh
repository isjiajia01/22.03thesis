...
#BSUB -J EXP01_Crunch_Baseline_greedy[1-10]
#BSUB -q hpc
#BSUB -o logs/exp01_greedy_%I.out
#BSUB -e logs/exp01_greedy_%I.err
#BSUB -n 1
#BSUB -W 01:00
#BSUB -R "rusage[mem=4GB]"


# Single-wave pressure, no defense (critical ratio) (greedy)
...
"$PYTHON_BIN" -m scripts.runner.master_runner --exp EXP01 --seed $SEED --override mode=greedy
