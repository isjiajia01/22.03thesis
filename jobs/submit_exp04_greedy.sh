...
#BSUB -J EXP04_Dynamic_Compute_RiskGate_greedy[1-10]
#BSUB -q hpc
#BSUB -o logs/exp04_greedy_%I.out
#BSUB -e logs/exp04_greedy_%I.err
#BSUB -n 2
#BSUB -W 04:00
#BSUB -R "rusage[mem=8GB]"
#BSUB -R "span[hosts=1]"

# Core contribution: Dynamic compute + RiskGate (greedy)
...
"$PYTHON_BIN" -m scripts.runner.master_runner --exp EXP04 --seed $SEED --override mode=greedy

echo "Completed EXP04 - Seed $SEED"
