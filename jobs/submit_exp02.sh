...
#BSUB -J EXP02_Static_Compute_Upper[1-10]
#BSUB -q hpc
#BSUB -o logs/exp02_%I.out
#BSUB -e logs/exp02_%I.err
#BSUB -n 2
#BSUB -W 04:00
#BSUB -R "rusage[mem=8GB]"
#BSUB -R "span[hosts=1]"

# Pure compute upper bound (300s, no defense) (proactive)
...
"$PYTHON_BIN" -m scripts.runner.master_runner --exp EXP02 --seed $SEED "${OVERRIDES[@]}"

echo "Completed EXP02 - Seed $SEED ($ENDPOINT_KEY)"
