...
#BSUB -o logs/EXP13b_%J_%I.out
#BSUB -e logs/EXP13b_%J_%I.err

# EXP13: EXP13b - Bandit-Augmented Allocator
# Git hash: unknown
# Generated: 2026-03-06T09:44:40.580561
...
echo "Job $LSB_JOBINDEX: variant=EXP13b, seed=$SEED, scenario=$SCENARIO"
